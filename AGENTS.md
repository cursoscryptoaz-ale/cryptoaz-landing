...
### El agente en Windows -- CRITICO
- Guarda archivos .tsx/.ts con UTF-8 BOM automaticamente
- REGLA PERMANENTE: despues de cualquier sesion del agente que modifique .tsx/.ts, correr limpieza BOM antes de commitear
- Script BOM:
```python
...
- Prompts largos para el agente: guardar en prompt.md en la raiz (en .gitignore)
